...
<div class="text-center">
  ...
  <div class=card-container>
    <div class="card-item">
      ...
      <div>Subject: {{$data->subject}}</div>
      <div>Grade Level: {{$data->gradelevel}}</div>
      <a href="" data-bs-toggle="modal" data-bs-target="#{{'preview',$data->id}}">Preview</a>
      <a href="{{url('/download', $data->file)}}">Download</a>
    </div>
  </div>
  <div class="modal fade" id="{{'preview',$data->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-xxl">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="staticBackdropLabel">Grade 1</h1>
